...
void SoPoly::init ( const GsColor& c, const GsColor& selc )
 {
	 /*_flatvsh.load_and_compile(GL_VERTEX_SHADER, "../flat.glsl");
	 _flatfsh.load_and_compile(GL_FRAGMENT_SHADER, "../mcol_flat.vert");
