...
void SoCapsule::build(float len, float rt, float rb, int nfaces, bool _flatn)
{
...
void SoCapsule::draw(const GsMat& tr, const GsMat& pr, const Light& l, const Material& m)
{
	// Draw Lines:
